...
public class EventBus
{
    ...
    public static void Publish<T>(T publishedEvent)
    {
        ...
        {
            IList subscriberList = new List<Subscription<T>>(topic.Cast<Subscription<T>>());
            ...
            foreach(Subscription<T> orphanSubscription in orphanedSubscriptions) {
                Unsubscribe(orphanSubscription);
            }
